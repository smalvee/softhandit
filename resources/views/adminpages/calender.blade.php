...
<!-- Mirrored from kvthemes.com/bangodash/color-version/calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2020 13:20:44 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <!--Full Calendar Css-->
    <link href='admin/plugins/fullcalendar/css/fullcalendar.css' rel='stylesheet' />
    <!-- simplebar CSS-->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            <div class="brand-logo">
                <a href="index.html">
                    <img src="admin/images/logo-icon.png" class="logo-icon" alt="Bangodash">
                ...
                <ul class="navbar-nav align-items-center right-nav-link">
                            ...
                            <ul class="list-group list-group-flush">
                                    ...
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3"
                                                    src="admin/images/avatars/avatar-1.png" alt="user avatar"></div>
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3"
                                                    src="admin/images/avatars/avatar-2.png" alt="user avatar"></div>
                                            <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3"
                                                    src="admin/images/avatars/avatar-3.png" alt="user avatar"></div>
                                            <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3"
                                                    src="admin/images/avatars/avatar-4.png" alt="user avatar"></div>
                                            <div class="media-body">
                    ...
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                            <span class="user-profile"><img src="admin/images/avatars/avatar-17.png"
                        ...
                        <ul class="dropdown-menu dropdown-menu-right animated fadeIn">
                            <li class="dropdown-item user-details">
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar"><img class="align-self-start mr-3"
                                                src="admin/images/avatars/avatar-17.png" alt="user avatar"></div>
                                        <div class="media-body">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div id='fc-wrap' class="shadow-sm">
                            <div id='calendar'></div>
    ...
    <!-- Full Calendar -->
    <script src='admin/plugins/fullcalendar/js/jquery-ui.custom.min.js'></script>
    <script src='admin/plugins/fullcalendar/js/fullcalendar.js'></script>
    <script src="admin/plugins/fullcalendar/js/fullcalendar-custom-script.js"></script>

</body>

<!-- Mirrored from kvthemes.com/bangodash/color-version/calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2020 13:20:56 GMT -->
