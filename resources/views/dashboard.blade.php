                ...
                <ul class="navbar-nav align-items-center right-nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right animated fadeIn">
                            ...
                            <li class="dropdown-item"><i class="icon-power mr-2"></i> {{ __('Log Out') }}</li>
                        </x-dropdown-link>
                    </form>
                        </ul>
                    </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-xl-4">
                                        ...
                                        <p class="mt-3"><i class="flag-icon flag-icon-ca mr-1"></i> Canada
                                            <span class="float-right">65%</span></p>
                                        <div class="progress" style="height: 7px;">
                                        ...
                                        <p class="mt-3"><i class="flag-icon flag-icon-gb mr-1"></i> England
                                            <span class="float-right">85%</span></p>
                                        <div class="progress" style="height: 7px;">
                                        ...
                                        <p class="mt-3"><i class="flag-icon flag-icon-in mr-1"></i> India
                                            <span class="float-right">45%</span></p>
                                        <div class="progress" style="height: 7px;">
                    ...
                    <div class="card border-right">
                        ...
                        <ul class="list-group list-group-flush list shadow-none">
                            <li class="list-group-item d-flex justify-content-between align-items-center">Gross Profit
                                <span class="badge gradient-quepal text-white badge-pill shadow">05</span></li>
